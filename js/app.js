...
!function ($) {
    ...
    LeftSidebar.prototype._reset = function() {
        ...
        $('#side-main-logo').attr('src', 'images/logo.png');
        $('#side-sm-main-logo').attr('src', 'images/logo_sm.png');
    },
    ...
    LeftSidebar.prototype.activateLightTheme = function() {
        this._reset();
        $('#side-main-logo').attr('src', 'images/logo-dark.png');
        $('#side-sm-main-logo').attr('src', 'images/logo_sm_dark.png');
